...
// Funcion para eliminar duplicados dentro de un array
...
Listado.prototype.obtenerCiudad = function() {
              ...
              //opcion 1 ES5
                //  const arrayCiudades = this.restaurantes.map(function (elemento) {
                //    return elemento.ubicacion;
                //  });

    //Opcion 2 de uso map method con ES6
...
Listado.prototype.obtenerHorario = function() {
    ...
    const arrayConArrayDeHorarios = this.restaurantes.map(function (array) {
        return array.horarios;
    });
    // console.log(arrayConArrayDeHorarios);
     
    // En este arreglo vamos a poner todos los horarios, uno por uno, aparecen además los valores repetidos
    arrayHorarios = arrayConArrayDeHorarios.reduce((acc, it) => [...acc, ...it], [])
    // console.log(arrayHorarios);
     //En este arreglo vamos a poner todos los horarios pero sin repetidos
     return eliminarDuplicados(arrayHorarios);
}
